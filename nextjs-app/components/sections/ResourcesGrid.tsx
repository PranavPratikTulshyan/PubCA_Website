...
// Config source: config/pages/resources.json → sections[1]
  ...
  return (
    ...
    >
      <div className="text-center">
        <p className="font-heading text-lg text-primary-700 font-semibold">ResourcesGrid</p>
